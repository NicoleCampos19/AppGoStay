...
class ClaseConexion {
    ...
    fun cadenaConexion(): Connection?{
        try {
            ...
            val ipprueba = "jdbc:oracle:thin:@10.10.0.51:1521:xe"
            val ipBryan = "jdbc:oracle:thin:@172.24.160.1:1521:xe"
            ...
            val conexion = DriverManager.getConnection(ipBryan, usuario, contrasena)
